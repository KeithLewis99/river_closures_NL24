### Terra Nova combo 2023 (and 2022)

# 2023 Temperature logger data processing for Terra Nova
...
# ---- Upload ----
dirs <- list.dirs( path = "./data-working/Terra Nova Temperature Logger Folders/" )
dirs <- dirs[-1]
