...
dirs <- list.dirs( path = "./data-working/Temperature-Files//2024-01-11/" ) # figure out how to automatically select relevant directory
...
write.csv(TZs, "./data-working/output/2023-timezones.csv", row.names = FALSE)
